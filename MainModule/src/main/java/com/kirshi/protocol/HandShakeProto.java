...
public final class HandShakeProto {
  ...
  public enum HandShakeStatus
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return HandShakeProto.getDescriptor().getEnumTypes().get(1);
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return HandShakeProto.internal_static_com_kirshi_protocol_HandShakeMessage_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return HandShakeProto.internal_static_com_kirshi_protocol_HandShakeMessage_fieldAccessorTable
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (type_ != Type.CLIENT.getNumber()) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return HandShakeProto.internal_static_com_kirshi_protocol_HandShakeRespMessage_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return HandShakeProto.internal_static_com_kirshi_protocol_HandShakeRespMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              HandShakeRespMessage.class, Builder.class);
    }
    ...
    public HandShakeStatus getStatus() {
      HandShakeStatus result = HandShakeStatus.valueOf(status_);
      return result == null ? HandShakeStatus.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (status_ != HandShakeStatus.SUCCESS.getNumber()) {
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof HandShakeRespMessage)) {
        return super.equals(obj);
      }
      HandShakeRespMessage other = (HandShakeRespMessage) obj;
    ...
    public static HandShakeRespMessage parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static HandShakeRespMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static HandShakeRespMessage parseFrom(
    ...
    public static HandShakeRespMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static HandShakeRespMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static HandShakeRespMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(HandShakeRespMessage prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
      ...
      public HandShakeRespMessage getDefaultInstanceForType() {
        return HandShakeRespMessage.getDefaultInstance();
      }

      public HandShakeRespMessage build() {
        HandShakeRespMessage result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public HandShakeRespMessage buildPartial() {
        HandShakeRespMessage result = new HandShakeRespMessage(this);
        result.cmd_ = cmd_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof HandShakeRespMessage) {
          return mergeFrom((HandShakeRespMessage)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(HandShakeRespMessage other) {
        if (other == HandShakeRespMessage.getDefaultInstance()) return this;
        if (other.cmd_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        HandShakeRespMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (HandShakeRespMessage) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
       ...
       * <code>.com.kirshi.protocol.HandShakeStatus status = 2;</code>
       */
      public Builder setStatus(HandShakeStatus value) {
        if (value == null) {
          throw new NullPointerException();
        }
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final HandShakeRespMessage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new HandShakeRespMessage();
    }

    public static HandShakeRespMessage getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
