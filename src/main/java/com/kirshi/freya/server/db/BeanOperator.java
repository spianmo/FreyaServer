package com.kirshi.freya.server.db;

import com.kirshi.freya.server.db.annotation.Column;
import com.kirshi.freya.server.db.annotation.Param;
import com.kirshi.freya.server.db.annotation.Table;
import com.kirshi.freya.server.db.utils.DateUtil;
import com.kirshi.freya.server.db.utils.StringUtil;
 ...
 * @Project:FreyaServer
 * @Author:Finger
 * @FileName:BeanOperator.java
 * @LastModified:2021-03-29T17:16:09.337+08:00
 */
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                for (Field field : fields) {
                    ...
                    //如果标注为DBExclude，则忽略
                    if (field.isAnnotationPresent(com.hidata.framework.annotation.db.DBExclude.class)) {
                        com.hidata.framework.annotation.db.DBExclude exclude = field.getAnnotation(com.hidata.framework.annotation.db.DBExclude.class);
                        //获取元素值
