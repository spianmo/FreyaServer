 ...
 * @LastModified:2021-03-29T17:16:09.346+08:00
 */
...
public class JDBCTemplateManager implements DBManager {
    ...
    public <T> int insertObject(T obj) {
        String sql = BeanOperator.getSqlByObject(BeanOperator.SqlTypes.INSERT, obj);
    ...
    public <T> int insertObjectAndGetAutoIncreaseId(T obj) {
        final String sql = BeanOperator.getSqlByObject(BeanOperator.SqlTypes.INSERT, obj);
